...
describe("regeneration_by_plot", {
  it("output columns are correct", {
    expect_equal(
      ...
      c("plottype", "plot_id", "year", "period", "subplot_id",
...
describe("regeneration_by_plot_height", {
  it("output columns are correct", {
    expect_equal(
      ...
      c("plottype", "plot_id", "year", "period", "height_class", "subplot_id",
...
describe("regeneration_by_plot_species", {
  it("output columns are correct", {
    expect_equal(
      ...
      c("plottype", "plot_id", "year", "period", "subplot_id", "species",
...
describe("regeneration_by_plot_height_species", {
  it("output columns are correct", {
    expect_equal(
      ...
      c("plottype", "plot_id", "year", "period", "height_class", "species",
        "subplot_id", "rubbing_damage_perc",
        "approx_nr_regeneration_ha", "mean_number_of_regeneration_ha",
        "lci_number_of_regeneration_ha", "uci_number_of_regeneration_ha")
    )
  })
