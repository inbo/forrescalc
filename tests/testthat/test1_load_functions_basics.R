...
describe("load_data_herblayer()", {
  ...
  it("output columns are correct", {
    expect_equal(
      ...
      c("plot_id", "plottype", "totalplotarea_ha", "forest_reserve",
        "length_core_area_m", "width_core_area_m", "core_area_ha",
        "subplot_id", "date_vegetation", "species", "coverage_id",
        "browse_index_id", "period", "year", "plotarea_ha",
  ...
  it("output columns are correct", {
    expect_equal(
      ...
      c("plot_id", "plottype", "totalplotarea_ha", "forest_reserve",
        ...
        "period", "year", "subcircle", "subcirclearea_ha", "plotarea_ha",
        "rubbing_damage_perc", "approx_nr_regeneration",
...
describe("load_data_vegetation()", {
  ...
  it("output columns are correct", {
    expect_equal(
      ...
      c("plot_id", "plottype", "totalplotarea_ha", "forest_reserve",
        "length_core_area_m", "width_core_area_m", "core_area_ha",
        "subplot_id", "date_vegetation", "year_main_survey",
...
describe("load_plotinfo()", {
  ...
  it("output columns are correct", {
    expect_equal(
      colnames(plotinfo),
      c("plot_id", "plottype", "forest_reserve",
...
describe("load_height_models()", {
  ...
  it("output columns are correct", {
    expect_equal(
      ...
      c("plottype", "period", "species", "model", "P1", "P2", "forest_reserve")
    )
  })
})
