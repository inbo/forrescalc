#' query all periods from fieldmap database
#'
...
#'
#' @param query query that is adapted to be used in different periods, in which
#' following parameters can be used:
#' - `%1$d` : replaced by the period number,
#' - `%2$s` : replaced by an empty string in period 1 and by '_?eSet' in all other periods
