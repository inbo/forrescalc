...
#'
#' @param dendro_by_plot_year data on the level of plot and year, e.g. table dendro_by_plot_year in git repository forresdat or the result of function calculate_dendro_plot_year()
#'
...
#' dendro_by_plot_year <-
#'   read_git(tablename = "dendro_by_plot_year", repo_path = "C:/gitrepo/forresdat")
#' statisticize_dendro_forres_year(dendro_by_plot_year)
#' }
#'
#' @export
#'
...
#'
create_statistics_dendro_forres <- function(dendro_by_plot_year) {
  by_forres_year <- dendro_by_plot_year %>%
    mutate(
