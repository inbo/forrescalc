...
#'
#' This function calculates for each plot and year the number of species, total number of trees and game damage percentage for generation (for all height classes together).
#'
