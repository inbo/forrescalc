...
#'
#' # only run this after writing a commit with `save_results_git()` or
#' # `from_access_to_git()` that has not yet been pushed to Github!
#' remove_last_commit_git(repo_path = path_to_forresdat)
#' }
#'
#' @export
#'
