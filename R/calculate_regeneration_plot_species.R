...
#'
#' @return dataframe with columns plot, subplot, species, year, period,
...
#' calculate_regeneration_plot_species(data_regeneration)
#'
#' @export
#'
...
calculate_regeneration_plot_species <- function(data_regeneration) {
  ...
  by_plot <- data_regeneration %>%
    ...
    summarise(
      plotarea_a1_ha = ifelse(!is.na(subcircle),
                              max(.data$plotarea_ha * (.data$subcircle == "A1")),
                              plotarea_ha),
      plotarea_a2_ha = ifelse(!is.na(subcircle),
                              max(.data$plotarea_ha * (.data$subcircle == "A2")),
                              plotarea_ha),
